...
<body class="bg-gray-100 text-gray-800 font-sans flex min-h-screen">
   ...
   class="block px-4 py-2 rounded-lg {{ request()->is('admin/products*') ? 'bg-gray-900 text-white' : 'text-gray-700 hover:bg-gray-200' }}">
   🛍️ Products
</a>
<a href="{{ route('admin.settings.index') }}"
   class="block px-4 py-2 rounded-lg {{ request()->is('admin/settings*') ? 'bg-gray-900 text-white' : 'text-gray-700 hover:bg-gray-200' }}">
   ⚙️ Settings
</a>
